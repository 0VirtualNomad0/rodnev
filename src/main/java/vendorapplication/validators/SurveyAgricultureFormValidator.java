...
@Component
public class SurveyAgricultureFormValidator implements Validator {
    @Override
    public boolean supports(Class<?> aClass) {
        return vendorAgriApplicationForm.class.equals(aClass);
    }

    @Override
    public void validate(Object o, Errors errors) {
        vendorAgriApplicationForm applicationForm = (vendorAgriApplicationForm) o;
