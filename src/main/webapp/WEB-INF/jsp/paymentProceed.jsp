   ...
   <div class="content-wrapper" style="background-color:#FFFFFF;">
      <div class="row ">
         ...
         <div class="table-responsive col-lg-6">
            <h4 class="text-left col-lg-12">
               <spring:message code="paymentpage.heading"/>
            </h4>
            <hr>
               ...
               <tbody>
                  <tr>
                     <td class="text-center">
                        <spring:message code="paymentpage.application.no"/>
                     </td>
                  ...
                  <tr>
                     <td class="text-center">
                        <spring:message code="paymentpage.application.username"/>
                     </td>
                  ...
                  <tr>
                     <td class="text-center">
                        <spring:message code="paymentpage.application.age"/>
                     </td>
                     <td class="text-center" > ${user.userId.age}  </td>
                  </tr>
                  <tr class="text-center">
                     <td>
                        <spring:message code="paymentpage.application.category"/>
                     </td>
                     <td class="text-center"> ${user.category.categoryName}  </td>
                  </tr>
                  <tr class="text-center">
                     <td>
                        <spring:message code="paymentpage.application.type"/>
                     </td>
                     <td class="text-center"  > ${user.subcategory.subCategoryName}  </td>
                  </tr>
                  <tr>
                     <td class="text-center">
                        <spring:message code="paymentpage.application.mobile"/>
                     </td>
                  ...
                  <tr>
                     <td class="text-center">
                        <spring:message code="paymentpage.application.totaldays"/>
                     </td>
                  ...
                  <tr>
                     <td class="text-center">
                        <spring:message code="paymentpage.application.itemNumber"/>
                     </td>
                  ...
                  <tr class="text-center">
                     <td >
                        <spring:message code="paymentpage.application.security"/>
                     </td>
                     <td class="text-center" ><%= session.getAttribute("security") %></input>
                  </tr>
                  <tr class="text-center">
                     <td >
                        <spring:message code="paymentpage.application.amounttopay"/>
                     </td>
      ...
      <h4 class="text-center col-lg-12" >
         <spring:message code="paymentpage.application.feedetails"/>
      </h4>
      <div class="row">
         ...
         <table class="col-lg-10 table table-hover table-bordered">
            <thead>
               <tr>
                  <th>
                     <spring:message code="paymentpage.application.sno"/>
                  </th>
                  <th>
                     <spring:message code="paymentpage.application.categoryname"/>
                  </th>
                  <th>
                     <spring:message code="paymentpage.application.subcategory"/>
                  </th>
                  <th>
                     <spring:message code="paymentpage.application.landtype"/>
                  </th>
                  <th>
                     <spring:message code="paymentpage.application.nationality"/>
                  </th>
                  <th>
                     <spring:message code="paymentpage.application.regionalNational"/>
                  </th>
                  <th>
                     <spring:message code="paymentpage.application.items"/>
                  </th>
                  <th>
                     <spring:message code="paymentpage.application.fee"/>
                  </th>
               </tr>
            </thead>
            <tbody>
               ...
               <c:if test="${not empty user.app_items}">
                  <c:forEach items="${user.app_items}" var="application" varStatus="loopCounter">
                     <tr>
                        ...
                        <td>${user.subcategory.subCategoryName}</td>
                        <td>${user.purposeActivity.landTypeName}</td>
                        <td>${user.nationalityEntity.nationalityName}</td>
