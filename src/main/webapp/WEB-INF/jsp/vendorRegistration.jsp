...
<section class="container" style="margin-top:30px; margin-bottom:30px;">
   <div class="row">
      <h2 class="col-lg-12 text-center"  style="color:#77332F;"> Registration/ Sign up </h2>
      <br>
   </div>
   <div class="row">
      <div class="col-lg-3"> &nbsp </div>
      <div class="col-lg-6" style="padding:10px; marging:10px; background-color:#F2F2F2; ">


   <form:form method="POST" modelAttribute="registerUser" action="${pageContext.request.contextPath}/savevendor" class="form-signin">
