  ...
  <div class="row">
         ...
         <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}">
            ...
            <form:input id="familyHead" type="text" onkeypress="return alpha(event)" oncopy="return false" onfocus="this.removeAttribute('readonly');" onpaste="return false" autocomplete="off" path="familyHead" name="familyHead" class="form-control"
               autofocus="true"></form:input>
            <form:errors  path="familyHead"></form:errors>
         </div>
      </spring:bind>
        ...
        <spring:bind path="educationalQualification">
           <div class="form-group col-lg-4 ${status.error ? 'has-error' : ''}">
              ...
              <form:errors  path="educationalQualification"></form:errors>
           </div>
        </spring:bind>
                     ...
                     <div class="row" style="margin-top:10px">
                        <spring:bind path="itemsForm[0].gender">
                           <div class="form-group col-lg-3 ${status.error ? 'has-error' : ''}">
                              ...
                              <form:errors  path="itemsForm[0].gender"></form:errors>
                           </div>
                        </spring:bind>
                        <spring:bind path="itemsForm[0].name">
                           <div class="form-group col-lg-3 ${status.error ? 'has-error' : ''}">
                              ...
                              <form:input id="itemsForm[0].name" autocomplete="off" onfocus="this.removeAttribute('readonly');" type="text" onkeypress="return alpha(event)" oncopy="return false" onpaste="return false"  path="itemsForm[0].name"  class="form-control"
                                 autofocus="true"></form:input>
                              <form:errors  path="itemsForm[0].name"></form:errors>
                           </div>
                        </spring:bind>
                        <spring:bind path="itemsForm[0].age">
                           <div class="form-group col-lg-3 ${status.error ? 'has-error' : ''}">
                              ...
                              <form:input id="itemsForm[0].age" autocomplete="off" onfocus="this.removeAttribute('readonly');" type="text" onkeypress="return alpha(event)" oncopy="return false" onpaste="return false"  path="itemsForm[0].age"  class="form-control"
                                 autofocus="true"></form:input>
                              <form:errors  path="itemsForm[0].age"></form:errors>
                           </div>
                        </spring:bind>
                        <spring:bind path="itemsForm[0].qualification">
                           <div class="form-group col-lg-3 ${status.error ? 'has-error' : ''}">
                              ...
                              <form:errors  path="itemsForm[0].qualification"></form:errors>
                           </div>
                        </spring:bind>
...
<script type="text/javascript">
    ...
    function addNewRow()
   {
    ...
    +'<div class="col-lg-3"><div class="form-group"><input oncopy="return false" onpaste="return false" maxlength="10" path="itemsForm['+add+'].name" name="itemsForm['+add+'].name"   class="form-control"   /></div></div>'
    +'<div class="col-lg-3"><div class="form-group"><input oncopy="return false" onpaste="return false" maxlength="10" path="itemsForm['+add+'].age" name="itemsForm['+add+'].age"   class="form-control"   /></div></div>'
