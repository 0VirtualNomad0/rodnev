         ...
         <div class="row" style="margin:0;padding:0;">
            ...
            <div class="col-xl-4" >
               <div class="flex_style" style="margin-top:5px;">
                  ...
                  <a class="text_decorate" href="${pageContext.request.contextPath}/login" ><spring:message code="mainpage.header.btn.dept.login" text="Department Login"/></a>
                  </div>
                    &nbsp;&nbsp;
                  <div class="form-group">
                     <select class="form-control" id="locales">
                        <option value="">
                           <spring:message code="mainpage.header.choose.lang" text="Choose Language"/>
                        </option>
                        <option value="en">
                           <spring:message code="mainpage.header.choose.lang.english" text="English"/>
                        </option>
                        <option value="hi">
                           <spring:message code="mainpage.header.choose.lang.hindi" text="Hindi"/>
                        </option>
                     </select>
                  </div>
               </div>
      ...
      <div class="header_logo_megamenu" >
         <div class="row ">
            ...
            <div class="col-xl-5 col-lg-5 col-md-10 col-sm-9 col-9 padding_">
               <div>
                  <p class="text-left text_logo_one"><spring:message code="mainpage.header.elahual" text="eLahaul (V1.0)"/></p>
               </div>
               <div>
                  <p class="text_logo_two"><spring:message code="mainpage.header.department.name" text="Department of Information Technology"/> </p>
               </div>
               <div>
                                 <p class="text_logo_three"><spring:message code="mainpage.header.government.name" text="Government of Himachal Pradesh"/> </p>
                              </div>
            </div>
             <div class="col-xl-5 col-lg-5 col-md-12">
                           <nav class="navbar_" style="margin-top: 15px;">
                              <ul >
                                 <li><a href="${pageContext.request.contextPath}/"> <img src="${pageContext.request.contextPath}/resources/images/vector/house.svg" class="icon_mega_menu"><span class="parent-menga-menu"><spring:message code="mainpage.header.btn.home" text="Home"/></span></a></li>
